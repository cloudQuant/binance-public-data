#!/usr/bin/env python3
"""
Binance COIN-M Futures Aggregated Trades Downloader (Monthly)

Downloads monthly aggregated trade history from Binance COIN-M futures.
...
Examples:
    ...
    python3 scripts/download-futures-cm-monthly-aggTrades.py -s ADAUSD_PERP

    # Download for specific year/month range
    python3 scripts/download-futures-cm-monthly-aggTrades.py -s ADAUSD_PERP BTCUSD_PERP -y 2023 2024

    # Download multiple symbols
    python3 scripts/download-futures-cm-monthly-aggTrades.py -s ADAUSD_PERP BCHUSD_PERP

    # Specify custom output folder
    python3 scripts/download-futures-cm-monthly-aggTrades.py -s ADAUSD_PERP -folder /data/binance
"""
...
def download_agg_trades_monthly(
    ...
    """
    Download COIN-M futures aggregated trades monthly data.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Binance COIN-M Futures Aggregated Trades Downloader (Monthly)',
    ...
    logger.info("Binance COIN-M Futures Aggregated Trades Downloader (Monthly)")
