#!/usr/bin/env python3
"""
Binance COIN-M Futures Mark Price Klines Downloader (Monthly)

Downloads monthly mark price kline history from Binance COIN-M futures.
...
Examples:
    ...
    python3 scripts/download-futures-cm-monthly-markPriceKlines.py -s ADAUSD_PERP

    # Download for specific year/month range with default intervals
    python3 scripts/download-futures-cm-monthly-markPriceKlines.py -s ADAUSD_PERP BTCUSD_PERP -y 2023 2024

    # Download with specific intervals
    python3 scripts/download-futures-cm-monthly-markPriceKlines.py -s ADAUSD_PERP -i 1m 1h 1d

    # Download multiple symbols
    python3 scripts/download-futures-cm-monthly-markPriceKlines.py -s ADAUSD_PERP BCHUSD_PERP

    # Specify custom output folder
    python3 scripts/download-futures-cm-monthly-markPriceKlines.py -s ADAUSD_PERP -folder /data/binance
"""
...
def download_mark_price_klines_monthly(
    ...
    """
    Download COIN-M futures mark price klines monthly data.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Binance COIN-M Futures Mark Price Klines Downloader (Monthly)',
    ...
    logger.info("Binance COIN-M Futures Mark Price Klines Downloader (Monthly)")
