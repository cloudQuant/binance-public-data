#!/usr/bin/env python3
"""
Binance USD-M Futures Daily Book Ticker Downloader

Optimized script for downloading daily book ticker (best bid/ask) history from Binance USD-M futures.
...
Examples:
    ...
    python3 scripts/download-futures-um-daily-bookTicker.py -s BTCUSDT

    # Download for specific date range
    python3 scripts/download-futures-um-daily-bookTicker.py -s BTCUSDT -startDate 2024-01-01 -endDate 2024-12-31

    # Download multiple symbols
    python3 scripts/download-futures-um-daily-bookTicker.py -s BTCUSDT ETHUSDT

    # Specify custom output folder
    python3 scripts/download-futures-um-daily-bookTicker.py -s BTCUSDT -folder /data/binance
"""
...
def download_book_ticker_daily(
    ...
    """
    Download book ticker daily data with smart features.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Binance USD-M Futures Daily Book Ticker Downloader\n'
                    'Downloads DAILY book ticker data.',
    ...
    logger.info("Binance USD-M Futures Daily Book Ticker Downloader")
