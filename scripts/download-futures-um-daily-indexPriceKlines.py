#!/usr/bin/env python3
"""
Binance USD-M Futures Daily Index Price Klines Downloader

Optimized script for downloading daily index price klines history from Binance USD-M futures.
...
Examples:
    ...
    python3 scripts/download-futures-um-daily-indexPriceKlines.py -s BTCUSDT

    # Download for specific date range
    python3 scripts/download-futures-um-daily-indexPriceKlines.py -s BTCUSDT -startDate 2024-01-01 -endDate 2024-12-31

    # Download with specific intervals
    python3 scripts/download-futures-um-daily-indexPriceKlines.py -s BTCUSDT -i 1h 4h 1d

    # Download multiple symbols
    python3 scripts/download-futures-um-daily-indexPriceKlines.py -s BTCUSDT ETHUSDT

    # Specify custom output folder
    python3 scripts/download-futures-um-daily-indexPriceKlines.py -s BTCUSDT -folder /data/binance
"""
...
def download_index_price_klines_daily(
    ...
    """
    Download index price klines daily data with smart features.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Binance USD-M Futures Daily Index Price Klines Downloader\n'
                    'Downloads DAILY index price klines data.',
    ...
    logger.info("Binance USD-M Futures Daily Index Price Klines Downloader")
