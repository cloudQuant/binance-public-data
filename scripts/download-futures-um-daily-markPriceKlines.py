#!/usr/bin/env python3
"""
Binance USD-M Futures Daily Mark Price Klines Downloader

Optimized script for downloading daily mark price klines history from Binance USD-M futures.
...
Examples:
    ...
    python3 scripts/download-futures-um-daily-markPriceKlines.py -s BTCUSDT

    # Download for specific date range
    python3 scripts/download-futures-um-daily-markPriceKlines.py -s BTCUSDT -startDate 2024-01-01 -endDate 2024-12-31

    # Download with specific intervals
    python3 scripts/download-futures-um-daily-markPriceKlines.py -s BTCUSDT -i 1h 4h 1d

    # Download multiple symbols
    python3 scripts/download-futures-um-daily-markPriceKlines.py -s BTCUSDT ETHUSDT

    # Specify custom output folder
    python3 scripts/download-futures-um-daily-markPriceKlines.py -s BTCUSDT -folder /data/binance
"""
...
def download_mark_price_klines_daily(
    ...
    """
    Download mark price klines daily data with smart features.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Binance USD-M Futures Daily Mark Price Klines Downloader\n'
                    'Downloads DAILY mark price klines data.',
    ...
    logger.info("Binance USD-M Futures Daily Mark Price Klines Downloader")
