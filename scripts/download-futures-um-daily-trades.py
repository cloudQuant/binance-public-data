#!/usr/bin/env python3
"""
Binance USD-M Futures Daily Trades Downloader

Optimized script for downloading daily trades history from Binance USD-M futures.
...
Examples:
    ...
    python3 scripts/download-futures-um-daily-trades.py -s BTCUSDT

    # Download for specific date range
    python3 scripts/download-futures-um-daily-trades.py -s BTCUSDT -startDate 2024-01-01 -endDate 2024-12-31

    # Download multiple symbols
    python3 scripts/download-futures-um-daily-trades.py -s BTCUSDT ETHUSDT

    # Specify custom output folder
    python3 scripts/download-futures-um-daily-trades.py -s BTCUSDT -folder /data/binance
"""
...
def download_trades_daily(
    ...
    """
    Download trades daily data with smart features.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Binance USD-M Futures Daily Trades Downloader\n'
                    'Downloads DAILY trades data.',
    ...
    logger.info("Binance USD-M Futures Daily Trades Downloader")
