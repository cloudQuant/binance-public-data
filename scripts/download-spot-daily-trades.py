#!/usr/bin/env python3
"""
Binance Spot Daily Trades Downloader

Optimized script for downloading daily individual trade data from Binance spot market.

Features:
- Downloads DAILY individual trade data for spot market
...
Examples:
    ...
    python3 scripts/download-spot-daily-trades.py -s BTCUSDT

    # Download for specific date range
    python3 scripts/download-spot-daily-trades.py -s BTCUSDT -startDate 2023-01-01 -endDate 2023-12-31

    # Download multiple symbols
    python3 scripts/download-spot-daily-trades.py -s BTCUSDT ETHUSDT

    # Download all spot symbols
    python3 scripts/download-spot-daily-trades.py

    # Specify custom output folder
    python3 scripts/download-spot-daily-trades.py -s BTCUSDT -folder /data/binance
"""
...
def download_trades_daily(
    ...
    """
    Download daily trade data for spot market.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Binance Spot Daily Trades Downloader\n'
                    'Downloads DAILY individual trade data for spot market.',
    ...
    logger.info("Binance Spot Daily Trades Downloader")
