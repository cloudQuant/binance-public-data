#!/usr/bin/env python3
"""
Binance Spot Aggregated Trades Downloader (Monthly Only)

Optimized script for downloading aggregated trade history from Binance spot market.
This script downloads MONTHLY aggregated trade data.
...
Examples:
    ...
    python3 scripts/download-spot-monthly-aggTrades.py -s BTCUSDT

    # Download for specific year/month range
    python3 scripts/download-spot-monthly-aggTrades.py -s BTCUSDT -y 2023 2024

    # Download multiple symbols
    python3 scripts/download-spot-monthly-aggTrades.py -s BTCUSDT ETHUSDT

    # Download for specific months
    python3 scripts/download-spot-monthly-aggTrades.py -s BTCUSDT -y 2024 -m 1 2 3

    # Specify custom output folder
    python3 scripts/download-spot-monthly-aggTrades.py -s BTCUSDT -folder /data/binance
"""
...
def download_agg_trades_monthly(
    ...
    """
    Download spot aggregated trade monthly data with smart features.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Binance Spot Aggregated Trades Downloader (Monthly Only)\n'
                    'Downloads MONTHLY aggregated trade data.',
    ...
    logger.info("Binance Spot Aggregated Trades Downloader (Monthly Only)")
